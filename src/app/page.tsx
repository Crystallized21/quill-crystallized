...
export default function Home() {
  return (
    <>
      <MaxWidthWrapper className="mb-12 mt-28 sm:mt40 flex flex-col items-center justify-center text-center">
          ...
          <div>
            <div className="mx-auto max-w-6xl px-6 lg:px-8">
              <div className="mt-16 flow-root sm:mt-24">
                <div className="-m-2 rounded-xl bg-gray-900/5 ring-1 ring-inset ring-gray-900/10 lg:-m-4 lg:p-4">
                  <Image
        ...
        <ol className="my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0">
          ...
          <li className="md:flex-1">
            <div
              ...
              <span className="mt-2 text-zinc-700">
                It&apos;s that simple. Start asking questions and get answers right away. Try Quill today!
              </span>
            </div>
          </li>
        </ol>
